import style from './Emplyee.module.css'
                ...
                }
                {
                    props.person.company ?
                        <div className="company">
                            <strong>Комания: </strong>
                            <sapn>{props.person.company.name}</sapn>
                        </div>: ''
                }
                {
                    props.person.company ?
                        <div className="company">
                            <img className={style.logo} src={props.person.company.logo} alt=""/>
                        </div>: ''
                }
                {
                    props.person.company ?
                        <div className="company">
                            ...
                            <sapn>{props.person.jobTitle}</sapn>
                        </div>: ''
                }
                {
                    props.person.age ?
